<template>
  <v-dialog persistent v-model="editDialogByUser" max-width="300">
    ...
    <v-card>
      ...
      <v-card-actions>
        <v-spacer></v-spacer>
        <v-btn flat @click.stop="editDialogByUser=false">Отмена</v-btn>
